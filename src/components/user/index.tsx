  ...
  return (
    <UserProvider user={user}>
      <div className="h-72">
        ...
        <span className="absolute left-0 top-0 h-48 w-full border-b-2 border-purple-400 bg-gradient-to-b from-purple-700 to-purple-200" />
      </div>
          ...
          <div className="justify-center">
            <div className="relative -mt-48">
              <Link to="/">
                ...
                <span className="mb-5 w-36 h-36 animate-spin rotate-[360] rounded-full block bg-gradient-to-tr from-purple-500 to-blue-300 p-2 ">
